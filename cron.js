...
const cronJob1 = async () => {
  ...
  try {
    ...
    console.log("Something went wrong in 30 min Insert cron.");
  }
};
...
Cron("*/55 * * * *", async () => {
  ...
  try {
    console.log("running a task every 55 minute.", new Date().toISOString());
    ...
    console.log("Something went wrong in 55 min Update cron.");
  } finally {
    corn2Running = false;
  }
});
